...
const MyBooking = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      <Title title="My Bookings" subTitle="Find and book your perfect stay at the best prices with ease. 
      Enjoy comfortable, secure, and hassle-free hotel bookings anywhere, anytime" align="left"/>
        ...
        {bookings.map((booking)=>(
            ...
            border-gray-300 py-6 first:border-t'>
                <div className='flex flex-col md:flex-row'>
                    <img src={booking.room.images[0]} alt="hotel-img" className='min-md:w-44 rounded shadow
                    object-cover'/>
                ...
                <div className='flex flex-col items-start justify-center pt-3'>
                    <div className='flex items-center gap-2'>
                        <div className={`h-3 w-3 rounded-full ${booking.isPaid ? "bg-green-500"
                        :"bg-red-500"}`}></div>
